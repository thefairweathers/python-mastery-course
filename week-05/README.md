...
[← Week 4: Functions & Scope](../week-04/README.md) · [Week 6: Object-Oriented Programming →](../week-06/README.md)
...
- **[Lab 5.1: Inventory System](labs/lab_01_inventory.py)** — Build an inventory system using dicts and sets
- **[Lab 5.2: Graph Traversal](labs/lab_02_graph.py)** — Implement BFS using deque and dict adjacency lists
