...
[← Week 1: Environment & Tooling](../week-01/README.md) · [Week 3: Control Flow →](../week-03/README.md)
...
- **[Lab 2.1: Type Explorer](labs/lab_01_types.py)** — Investigate Python's type system and object identity
- **[Lab 2.2: String Processor](labs/lab_02_strings.py)** — Build a text analysis tool using string methods
- **[Lab 2.3: Number Cruncher](labs/lab_03_numbers.py)** — Explore numeric precision and the Decimal module
