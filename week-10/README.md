...
[← Week 9: Modules & Packages](../week-09/README.md) · [Week 11: Advanced Patterns →](../week-11/README.md)
...
- **[Lab 10.1: Test Suite](labs/lab_01_testing.py)** — Write a comprehensive test suite for a task manager module
- **[Lab 10.2: Quality Pipeline](labs/lab_02_quality.md)** — Set up black, ruff, mypy, and pytest for an existing project
