...
[← Week 5: Data Structures](../week-05/README.md) · [Week 7: File I/O & Data Formats →](../week-07/README.md)
...
- **[Lab 6.1: Event System](labs/lab_01_events.py)** — Build a publish/subscribe event system using the Observer pattern
- **[Lab 6.2: Shape Library](labs/lab_02_shapes.py)** — Implement a shape hierarchy with ABC, inheritance, and composition
