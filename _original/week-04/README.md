...
[← Week 3: Control Flow](../week-03/README.md) · [Week 5: Data Structures →](../week-05/README.md)
...
- **[Lab 4.1: Memoization](labs/lab_01_memoize.py)** — Build a caching decorator from scratch
- **[Lab 4.2: Data Pipeline](labs/lab_02_pipeline.py)** — Compose functions into a text processing pipeline
