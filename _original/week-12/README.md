...
[← Week 11: Advanced Patterns](../week-11/README.md) · [Week 13: AI & Machine Learning →](../week-13/README.md)
...
- **[Lab 12.1: API Client](labs/lab_01_client.py)** — Build a typed Python client for a REST API
- **[Lab 12.2: REST API](labs/lab_02_api.py)** — Build a task management API with FastAPI
- **[Lab 12.3: Data Analysis](labs/lab_03_analysis.py)** — Analyze a CSV dataset with pandas and create visualizations
