...
[← Week 10: Testing](../week-10/README.md) · [Week 12: APIs & Data Engineering →](../week-12/README.md)
...
- **[Lab 11.1: Log Pipeline](labs/lab_01_pipeline.py)** — Build a generator-based log analysis pipeline
- **[Lab 11.2: Decorator Toolkit](labs/lab_02_decorators.py)** — Implement timer, retry, and caching decorators
- **[Lab 11.3: Async Fetcher](labs/lab_03_async.py)** — Fetch multiple URLs concurrently with asyncio
