---
title: "Week 3: Control Flow & Logic"
sidebar:
  order: 0
---
...
- **[Lab 3.1: FizzBuzz Three Ways](./lab-01-fizzbuzz)** — Implement FizzBuzz using loops, comprehensions, and pattern matching
- **[Lab 3.2: Data Filter Pipeline](./lab-02-filter)** — Process and analyze a dataset using comprehensions and control flow
