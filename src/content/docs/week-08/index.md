...
- **[Lab 8.1: Resilient Processor](./lab-01-processor)** — Build a data processor that handles errors gracefully and generates reports
- **[Lab 8.2: Custom Exception Hierarchy](./lab-02-exceptions)** — Design and implement a custom exception system for a REST API
