---
title: "Week 7: File I/O & Data Formats"
sidebar:
  order: 0
---
...
- **[Lab 7.1: Config Manager](./lab-01-config)** — Build a layered config system (defaults → file → environment variables)
- **[Lab 7.2: Log Parser](./lab-02-logs)** — Parse and analyze a log file using file I/O and data structures
